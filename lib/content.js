    ...
    sections: [
      {
        ...
        body: [
          { text: "KOAS is the main student housing operator in Jyväskylä, offering furnished and unfurnished rooms and shared apartments aimed specifically at students, usually cheaper than the open market.", link: { label: "KOAS", url: "https://www.koas.fi/", type: "web" } },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Nordea, OP, and S-Pankki are common choices among students. Book an appointment in advance - walk-ins are rare - and bring your passport, residence permit, and proof of address.",
        ...
        tip: "This step has the longest lead time of anything on this page. Start it in your first week.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        body: [
          "JYY (the student union) and subject-specific guilds run most of the orientation events, sitsit (themed dinners), and sports groups worth showing up to in your first month - most of your first friends will come from here.",
        ],
      },
      {
        heading: "Sauna",
